...
<div id="page-container" class="row">
		...
		<div class="actions">		
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Hierarchy.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Hierarchy.id'))); ?></li>
	...
	<div id="page-content" class="col-sm-9">
		...
		<h2><?php echo __('Edit Hierarchy'); ?></h2>
