		...
		<div class="actions">		
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Yakuza.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Yakuza.id'))); ?></li>
