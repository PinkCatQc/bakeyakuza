			...
			<ul class="nav nav-pills nav-stacked">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Hobby.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Hobby.id'))); ?></li>
